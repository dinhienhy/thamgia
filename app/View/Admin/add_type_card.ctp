...
<article class="module width_full">
    <header><h3>Thêm loại danh thiếp</h3></header>
        <div class="module_content">
            <form id="frm_type_card" name="frm_type_card" method="post" action="<?php echo $this->Html->url(array('controller' => 'Admin', 'action' =>'addTypeCard')) ?>" class="login-subscription">
                <fieldset>
