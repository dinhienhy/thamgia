<?php $card_vips = $this->requestAction(array('controller' => 'BusinessCards', 'action' => 'getCardVips', 4)); ?>
<?php $cards = $this->requestAction(array('controller' => 'BusinessCards', 'action' => 'getCards', 16)); ?>
